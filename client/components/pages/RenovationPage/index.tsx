        ...
        <div className="max-w-[90%] mx-auto">
          ...
          <div>
            ...
            <p className="defaultText max-w-4xl mb-7">
              Maecenas luctus vehicula condimentum. Sed condimentum in massa
              quis bibendum. Proin sapien leo, aliquam vitae dui sed, tristique
              porta odio. Interdum et malesuada fames ac ante ipsum primis in
              faucibus. Ut nec pretium dolor, sed ultrices risus. Phasellus
            ...
            <ul className="pl-5 list-disc">
              ...
              <li>
                preliminary selection of finishing materials, furniture and
